...
/**
 * 版本0.9
 * 重写keyReleased()方法，当按键抬起时的操作：任何方向键一旦被抬起就被重新赋值为false
 * 解决同时按下两个方向键的操控不灵活性
 */
public class Tank extends JFrame {
    ...
    //2.添加代表方向的量（使用枚举）
    private enum Direction {U, UR, R, RD, D, LD, L, LU, STOP}
    private Direction direction = Direction.STOP;  //默认状态下，坦克处于静止
